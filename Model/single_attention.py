...
class CrossAttentionModule(nn.Module):
    ...
    def Q_To_A(self, x1, x2):
        ...
        return attentive_a
class TToA(ImageEncoderTextEncoderBase):
    def __init__(self,args,**kwargs):
        super(TToA, self).__init__(**kwargs)
        self.args = args
        ...
        self.classnum = 4262
        self.text_dim = 3*300
        self.linear_layer = nn.Linear(self.text_dim,self.classnum)
    ...
    def forward(self, x):
        ...
        x_1 = self.cross_attention.A_To_Q(x_txt,x_tag).mean(dim=1)
        #print 'x_1'
        #print x_1.size()
        ...
        x_f = self.linear_layer(x_1)
        # x_f = self.linear_layer(torch.cat((x_1,x_2),dim=1))
        x_t = x[2][1]
        return (x_f,x_t)
class AToT(ImageEncoderTextEncoderBase):
    def __init__(self,args,**kwargs):
        super(AToT, self).__init__(**kwargs)
        self.args = args
        self.texts = kwargs.get('texts')
        self.cross_attention = CrossAttentionModule(args=self.args)
        self.model['norm'] = NormalizationLayer(learn_scale=True,
    ...
    def forward(self, x):
        ...
        #print 'x_1'
        #print x_1.size()
        x_1 = self.cross_attention.Q_To_A(x_tag,x_txt)
        #print 'x_2'
        #print x_2.size()
        # x_1 = self.model['norm'](x_1)
        # x_2 = self.model['norm'](x_2)
